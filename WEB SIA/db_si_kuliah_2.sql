...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Apr 2016 pada 11.00
-- Versi Server: 5.6.16
-- PHP Version: 5.5.11
...
('ccec4c982f904a301659c663a93ada3a', '192.168.12.215', 'Mozilla/5.0 (Linux; Android 4.2.2; GT-I9152 Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.78 Mobi', 1433476975, ''),
('21a4e18f9d1dcd6df02d8d0fb228766f', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.90 Safari/537.36', 1430130333, 'a:9:{s:9:"user_data";s:0:"";s:8:"username";s:5:"admin";s:5:"level";s:1:"1";s:9:"nama_user";s:5:"admin";s:7:"id_user";s:2:"25";s:8:"thn_ajar";s:9:"2014/2015";s:8:"semester";s:5:"Genap";s:7:"uts_uas";s:3:"UTS";s:9:"auto_date";b:1;}'),
('b7cdcad995566a448878a6b37c3513ff', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; rv:35.0) Gecko/20100101 Firefox/35.0', 1430131954, ''),
('d1b8593187a963cf171d489a6188e52a', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.87 Safari/537.36', 1459498271, 'a:9:{s:9:"user_data";s:0:"";s:8:"username";s:5:"admin";s:5:"level";s:1:"1";s:9:"nama_user";s:5:"admin";s:7:"id_user";s:2:"25";s:8:"thn_ajar";s:9:"2015/2016";s:8:"semester";s:5:"Genap";s:7:"uts_uas";s:3:"UTS";s:9:"auto_date";b:1;}');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_beban_non_fsm`
--
...
--
-- Dumping data untuk tabel `tb_beban_non_fsm`
--
...
--
-- Struktur dari tabel `tb_beban_non_if`
--
...
--
-- Dumping data untuk tabel `tb_beban_non_if`
--
...
--
-- Struktur dari tabel `tb_dosen_if`
--
...
--
-- Dumping data untuk tabel `tb_dosen_if`
--
...
--
-- Struktur dari tabel `tb_dosen_non_if`
--
...
--
-- Dumping data untuk tabel `tb_dosen_non_if`
--
...
(31, '2014/2015', 'Ganjil', 4, 2, 'NONIF001', 'IF001'),
(32, '2014/2015', 'Ganjil', 14, 1, 'IF001', 'NONIF001'),
(33, '2014/2015', 'Ganjil', 18, 2, 'IF001', 'IF014'),
(34, '2014/2015', 'Ganjil', 17, 2, 'IF001', 'IF004'),
(35, '2014/2015', 'Ganjil', 16, 2, 'IF004', 'IF009'),
(36, '2014/2015', 'Ganjil', 5, 2, 'IF004', 'IF005'),
(37, '2014/2015', 'Ganjil', 7, 2, 'IF005', 'IF003'),
(38, '2014/2015', 'Ganjil', 55, 1, 'IF005', 'IF003'),
(39, '2014/2015', 'Ganjil', 3, 2, 'IF002', 'IF012'),
(40, '2014/2015', 'Ganjil', 57, 2, 'IF002', 'IF017'),
(41, '2014/2015', 'Ganjil', 19, 2, 'IF007', 'IF020'),
(42, '2014/2015', 'Ganjil', 20, 2, 'IF007', 'IF016'),
(43, '2014/2015', 'Ganjil', 27, 2, 'IF007', 'IF008'),
(44, '2014/2015', 'Ganjil', 54, 2, 'IF008', 'IF013'),
(45, '2014/2015', 'Ganjil', 32, 2, 'IF008', 'NONIF002'),
(46, '2014/2015', 'Ganjil', 53, 2, 'IF008', 'IF013'),
(47, '2014/2015', 'Ganjil', 47, 1, 'IF009', 'IF012'),
(48, '2014/2015', 'Ganjil', 48, 1, 'IF009', 'IF023'),
(49, '2014/2015', 'Ganjil', 46, 1, 'IF012', 'IF022'),
(50, '2014/2015', 'Ganjil', 59, 2, 'IF012', 'IF023'),
(51, '2014/2015', 'Ganjil', 60, 2, 'IF020', 'IF021'),
(52, '2014/2015', 'Ganjil', 52, 2, 'IF020', 'IF014'),
(53, '2014/2015', 'Ganjil', 30, 2, 'IF010', 'IF017'),
(54, '2014/2015', 'Ganjil', 44, 1, 'IF010', 'IF022'),
(55, '2014/2015', 'Ganjil', 28, 1, 'IF010', 'IF014'),
(56, '2014/2015', 'Ganjil', 31, 1, 'IF016', 'IF013'),
(57, '2014/2015', 'Ganjil', 49, 1, 'IF016', 'IF023'),
(58, '2014/2015', 'Ganjil', 6, 2, 'IF013', 'IF023'),
(59, '2014/2015', 'Ganjil', 29, 2, 'IF021', 'IF017'),
(60, '2014/2015', 'Ganjil', 45, 1, 'IF021', 'IF022');
...
(10, 'operator', 'operator', '4b583376b2767b923c3e1da60d10de59', 2, 'operator@operator.com'),
(13, 'dosen', 'dosen', 'ce28eed1511f631af6b2a7bb0a85d636', 3, 'dosen@dosen.com'),
